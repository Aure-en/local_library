...
exports.author_create_post = [
  ...
  (req, res, next) => {
    ...
    // Create an Author object with escape and trimmed data
...
exports.author_delete_post = function (req, res, next) {
  async.parallel({
    ...
    if (results.authors_books.length > 0) {
      // Author has books so he can't be deleted. Render the route.
...
exports.author_update_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are errors, render the form with sanitized values / errors.
      res.render('author_form', { title: 'Update Author', author, errors: errors.array() });
    } else {
      // Data form is valid, update
